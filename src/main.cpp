...
{
    std::optional<uint32_t> graphicsFamily;  // this variable can store attributes or being empty.

    bool isComplete()
    {
        return graphicsFamily.has_value(); // if has value return true if empty returns false.
    }
};
